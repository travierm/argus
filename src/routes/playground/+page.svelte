...
<div class="flex min-h-screen flex-col gap-8 p-10">
	...
	<div class="flex flex-col gap-2">
		<div class="flex items-center justify-between">
			...
			<button on:click={toggleTheme} class="btn btn-outline btn-sm max-w-40">
				{isDark ? '☀️ Light Mode' : '🌙 Dark Mode'}
			</button>
		</div>

		<code class="flew-grow">class="btn btn-primary"</code>
	...
	<div class="flex flex-col gap-2">
		...
		<code class="flew-grow">class="card card-title card-body"</code>
		<div class="flex flex-wrap gap-2">
			<div class="card">
