...
const parser = {
    ...
    parse: function (source: string): DiffInfo[] {
        ...
        while (i < linesLen) {
            ...
            if (firstChar === 100 && line.charCodeAt(1) === 105 && line.charCodeAt(2) === 102 && line.charCodeAt(3) === 102) {
                ...
                simiLoop: while ((simiLine = lines[++i])) {
                    ...
                    switch (infoType) {
                        ...
                        case 'new': {
                            ...
                            if (leftStr.charCodeAt(0) === 102 && leftStr.charCodeAt(5) === 109) { // "file mode"
                        ...
                        case 'index': {
                            ...
                            currentInfo.newRevision = spaceIdx > -1
                        ...
                        case 'rename': {
                            ...
                            if (infoStr.charCodeAt(0) === 102) { // 'f' for "from"
                                currentInfo.oldPath = infoStr.slice(5);
                            }
                            else { // rename to / copy to
            ...
            // Check for "Binary" (B = 66)
                ...
                if (firstChar === 64 && line.charCodeAt(1) === 64) {
                    ...
                    switch (typeChar) {
                        ...
                        case 92: { // '\\' = 92 - Seems "no newline" is the only case starting with \
